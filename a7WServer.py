...
# Initialize Dash app with compatible configuration
...
# Clean data: replace West Germany with Germany
...
# Calculate win counts for choropleth
...
# Create choropleth map with red scale
fig = px.choropleth(
    win_counts,
    locations="iso_code",
    locationmode="ISO-3",
